...
public class AdminController {
	...
	public String userInsert(@RequestParam("user_id") String user_id, @RequestParam("user_name") String user_name, @RequestParam("email") String email, @RequestParam("user_pwd") String user_pwd, Locale locale, Model model) {
		UserVO userVO = new UserVO();
